...
func main() {
	...
	for { // Loop forever (you may want to do something smarter!)
		...
		msg := "jfw6fp"                            // replace with your UVa Computing ID (e.g., "dee2b")
		a := "PsVydhvYAcNBPK6Hz51UanuMUsqCJxFkVr" // replace with the address you want mining fees to go to (or leave it like this and Nick gets them)
